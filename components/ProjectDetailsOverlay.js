              ...
              {selectedContent ? (
                selectedContent.type === "artwork" ? (
                  <>
                    ...
                    <LikeButton
                      projectId={`${project.Name}-${selectedContent.content.title}-${project.Latitude}-${project.Longitude}`}
                    />
                  ...
                  <>
                    ...
                    <LikeButton
                      projectId={`${project.Name}-outcome-${selectedContent.content.title}`}
                    />
                  </>
                )
              ) : (
